...
/// Resolved on-disk locations for one ModManager installation.
///
...
impl Paths {
    ...
    pub fn resolve() -> Result<Self> {
        let dirs = ProjectDirs::from("", "ModManager", "ModManager").ok_or(Error::NoProjectDirs)?;
        Ok(Self {
